...
var cadena = "Cadena de texto"; // String
var numero = 18; // Numerico
var booleano = true; // Booleano
var any = 16; // Any
any = "Dieciseis";
var lenguajes = ["PHP", "JS", "CSS"]; // Array | Definicion 1: Definiciendo el nombre, seguido de la palabra Array y el tipo de datos que tiene el array
var numeros = [1, 2, 3, 4, 5]; // Array | Definicion 2: Definiendo el nombre el tipo de dato del array y corchetes, para despues igualar los valores del array
// Multiples tipos de datos en una variable:
var nombre = "Diego Oropeza"; // Con el pipe "|" se pueden asignar 2 tipos de datos validos para una variable. En este caso son validos strings y numeros, como valores para "nombre"
var nuevodato = "Diego Oropeza";
// Let Vs Var:
var numero1 = 10;
var numero2 = 12;
if (numero1 == 10) {
    ...
    console.log(numero1_1, numero2); // Salida de prueba
}
